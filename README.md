...
If you don't know what a neural network is, we recommend you finish first reading Section [1](#math_background) and [2](#nns_basics). These sections provide the resources to understand the basic math and idea behind neural networks as well as the notion behind neural network training. Before diving into the next sections, which talk about the necessary tools for training neural networks yourself, we recommend to visit the [Tensorflow Playground](https://playground.tensorflow.org/#activation=tanh&batchSize=10&dataset=circle&regDataset=reg-plane&learningRate=0.03&regularizationRate=0&noise=0&networkShape=4,2&seed=0.40188&showTestData=false&discretize=false&percTrainData=50&x=true&y=true&xTimesY=false&xSquared=false&ySquared=false&cosX=false&sinX=false&cosY=false&sinY=false&collectStats=false&problem=classification&initZero=false&hideText=false), where you can immediately start tinkering with neural nets in an interactive fashion without programming. 
